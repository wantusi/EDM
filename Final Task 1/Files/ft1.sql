...
--
-- Host: 127.0.0.1    Database: cayanan_db
-- ------------------------------------------------------
...
CREATE TABLE `event_sponsors_tbl` (
  ...
  CONSTRAINT `event_sponsors_tbl_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `events_tbl` (`event_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `events_attendees_tbl` (
  ...
  CONSTRAINT `events_attendees_tbl_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `events_tbl` (`event_id`),
  CONSTRAINT `events_attendees_tbl_ibfk_2` FOREIGN KEY (`attendee_id`) REFERENCES `attendees_tbl` (`attendee_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-05-10 22:41:50
